...
<body bgcolor=#F5F6F7>
  <div style="overflow: auto; background-color:#729DD2; width:1060px; height:115px;">
    <h1 style="margin-top:15px; color:white; font-size:50px;">&nbsp;&nbsp;<a class="underbar" href="mobile.php">Dae Bak Cloud</a></h1>
  </div>
  ...
  <div style="position: absolute; left:700px; top:130px;">
    <span>
      <?php
      if($is_logged=='YES')
  ...
  <table>
    ...
    <tr>
      <div style="position: absolute; text-align:left; left:730px; top:200px;"><br>
          <div>
            <h2></h2>
            <!-- <h2> 사용가능 : 1000GB </h2> -->
            <?php
  ...
  <div id="iframe" class="iframe">
    <iframe src="list.php" width="1100" height="1500"></iframe>
  </div>
